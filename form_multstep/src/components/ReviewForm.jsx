  ...
  return (
    <div className='review-form'>
       ...
       <label className='radio-container'>
        ...
        <label className='radio-container'>
          <input type="radio" value="very-satisfied" name='review' required  checked={data.review === "very-satisfied"}
          onChange={(e) => updateFieldHandler("review", e.target.value)}/>
          <BsFillEmojiHeartEyesFill/>
       ...
       <div className="form-control">
        ...
        <textarea name="comment" id="comments" placeholder='Conte como foi a sua experiencia com o Produto' required 
         value={data.comment || ""}
